...
const NETWORK_CONFIGS = {
    ETH: {
        ...
        wsProvider: `wss://distinguished-twilight-lake.quiknode.pro/${process.env.ETH_QUICKNODE_KEY}/`,
        rpcProvider: `https://distinguished-twilight-lake.quiknode.pro/${process.env.ETH_QUICKNODE_KEY}/`,
    ...
    BSC: {
        ...
        wsProvider: `wss://thrilling-late-dawn.bsc.quiknode.pro/${process.env.BSC_QUICKNODE_KEY}`,
        rpcProvider: `https://thrilling-late-dawn.bsc.quiknode.pro/${process.env.BSC_QUICKNODE_KEY}`,
        explorer: 'https://bscscan.com/token/',
        dexScreenerBase: 'https://api.dexscreener.com/latest/dex/tokens/'
    },
    SOL: {
        raydiumProgram: '675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8', // Raydium Liquidity Pool V4 Program
        wsProvider: `https://snowy-stylish-panorama.solana-mainnet.quiknode.pro/${process.env.SHYFT_KEY}/`,
